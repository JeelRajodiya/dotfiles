...
import { addTokenCounts, formatAgentTokens, sessionTokenCounts, tokenCountsFromUsage } from "../dotfiles/agents/.pi/agent/extensions/agent-team-helpers.ts";
...
try {
	...
	assert.deepEqual(sessionTokenCounts(session), { input: 33_099, output: 4_019 });
